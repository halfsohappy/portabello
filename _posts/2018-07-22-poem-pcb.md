---
layout: post
title: A Quick and Dirty PCB to (Hopefully) Finish A Year-long Project
date: 2018-07-22 00:00:00 -0000
tags: [projects, hardware, ongoing]
image: poem_pcb.jpg
---

Hopefully, this will simplify the final assembly and mitigate integration hell enough that this gift for Christmas 2023 will be ready in time for Christmas 2024.
...
<div class="container">
  <div class="row">
    <div class="col-sm">
      <div style="text-align: center;"> {% include captioned-image.html url="profile-photo-annie.jpg" description="caption" style="height: 150px;" %} </div>
    </div>
    <div class="col-sm">
      <div style="text-align: center;"> {% include captioned-image.html url="poem_pcb.jpg" description="da pcb" style="height: 150px;" %} </div>
    </div>
    <!-- <div class="col-sm">
...
[aws-architecture]: /assets/img/profile-photo-annie.jpg "AWS Architecture"